...
export default class CalendarStrip extends Component {
    ...
    getPreviousWeek() {
        ...
        if (this.props.onWeekChanged) {
            if(this.props.useIsoWeekday) {
                this.props.onWeekChanged(previousWeekStartDate.clone().startOf('isoweek'), this.formatCalendarHeader());
            }
            else {
                this.props.onWeekChanged(previousWeekStartDate.clone(), this.formatCalendarHeader());
            }
        }
    }
    ...
    getNextWeek() {
        ...
        if (this.props.onWeekChanged) {
            if(this.props.useIsoWeekday) {
                this.props.onWeekChanged(nextWeekStartDate.clone().startOf('isoweek'), this.formatCalendarHeader());
            }
            else {
                this.props.onWeekChanged(nextWeekStartDate.clone(), this.formatCalendarHeader());
            }
        }
    }
    ...
    getFormattedDate() {
        return this.formatCalendarHeader();
    }
    ...
    render() {
        ...
        return (
            <View style={[styles.calendarContainer, {backgroundColor: this.props.calendarColor}, this.props.style]}>
                { this.props.showHeader && calendarHeader }
